...
####################################################################################################################################
def prepareGTF(fileExons, outputFile):
    """
        
        args:
            fileExons: exon intervals taken from gtf file 
    ...
    df_mod.to_csv(outputFile, sep="\t", index=False) 
    
if __name__== "__main__":
    fileExons = "/project/6019283/aaseel/Aim2/Data/Metadata/intervalsExon_fullDetails.txt"
    outputFile = "/project/6019283/aaseel/Aim2/Data/Metadata/intervalsExon_fullDetails_new.txt"
    prepareGTF(fileExons, outputFile)
